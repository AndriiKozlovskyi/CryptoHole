<template>
	<div class="relative flex bg-[#141418] items-center h-min rounded-xl flex-col w-min"
	@mouseenter="hovered = true"
	@mouseleave="hovered = false" >
		<p class="font-bold p-5">{{ name }}</p>

		<DropZone :id="id"/>
		<CreationBar class="relative w-[16rem]" v-if="isCreationBarVisible"/>
...
const showCreartionBar = () => {
	console.log("byhUYU")
	isCreationBarVisible.value = !isCreationBarVisible.value;
}
defineProps({
	name: String,
	id: String,
