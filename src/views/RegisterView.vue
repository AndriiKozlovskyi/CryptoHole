  ...
  <div class="flex flex-col gap-y-1 h-full w-full justify-center items-center">
    ...
    >
      <div class="flex flex-col h-[2.5rem] justify-end">
        <p v-if="usernameExists" class="text-red-500 text-[12px] apple-font px-3">
      ...
      <div class="flex flex-col h-[2.5rem] justify-end">
        <p v-if="emailExists" class="text-red-500 text-[12px] apple-font px-3">
      ...
      <div class="flex flex-col h-[2.5rem] justify-end">
        ...
        <p v-else-if="!passwordValid" class="text-red-500 text-[12px] apple-font px-3">
          * min 8 characters
        </p>
        <PasswordInput
      ...
      <div class="flex flex-col h-[2.5rem] justify-end">
        <p v-if="repeatedPasswordEmpty" class="text-red-500 text-[12px] apple-font px-3">
          * Confirm password cannot be empty
        </p>
        <p v-else-if="!passwordsMatch" class="text-red-500 text-[12px] apple-font px-3">
