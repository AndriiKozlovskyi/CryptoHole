  ...
  <div class="flex h-100% w-full flex-row justify-start items-center">
    <main class="w-full h-full flex justify-between font">
      <div class="absolute h-100% flex flex-col mt-[1rem] space-y-10 ml-[5rem] max-w-[40rem]">
        <p class="text-white z-[300] text-3xl ml-16 font-extrabold mb-10 relative top-[3.5rem] p-4">
          Step - by - step guide
        </p>
      ...
      >
        <div class="mt-10 ml-auto mr-auto">
          <i
            class="pi pi-arrow-left text-secondary-text-color text-2xl top-[1rem] right-[1rem] absolute hover:cursor-pointer transition-transform duration-300 hover:-translate-x-2"
            @click="router.go(-1)"
          ></i>

          <div class="relative">
            <img
              src="https://cdn.prod.website-files.com/6310e7dee49f0866da8eed4c/63adcc1db02d660497f9957e_Drift%20Full%20Logo%20White.png"
              alt="Logo"
              class="w-full h-auto"
            />
          ...
          <div class="flex flex-col space-y-5 mt-8 text-sm relative">
            <div class="flex flex-row space-x-3">
              ...
              <a
                class="text-blue-500 font-bold text-large hover:text-blue-400"
                target="_blank"
                href="https://www.drift.trade/drift-governance-token"
                >Drift Governance Token</a
              >
              <SaveButton
