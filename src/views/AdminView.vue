<template>
    <div class="relative text-white w-full items-center justify-center flex overflow-hidden h-[23rem] flex-col rounded-lg">
        ...
        <button label="Save" class="bg-white mt-10 text-black text-lg text-center px-3 py-1 hover:bg-gray-500 rounded-lg" @click="save">Save</button>
    </div>
    <Toast/>
...
const save = () => {
    const project: Project = {name: name.value, tag: tag.value, expenses: expenses.value, src: imgSrc.value, participants: 0 }
